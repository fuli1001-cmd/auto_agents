        ...
        if self.mode == "fix":
            ...
            lines.extend(
                [
                    ...
                    "- When a retained task plan exists, issue_seed must identify its matching existing task_id/task_ids or requirement_ids. Never invent task ownership or adopt another workflow's work. Omit scope IDs only when no task contract exists.",
