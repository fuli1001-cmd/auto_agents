...
_MODULES = {
    ...
    'auto_agents.orchestrator': ('Orchestrator.resume_saved_run',
        ...
        'Orchestrator._record_iteration_plan_continuation', 'Orchestrator._resume_provider_reference_review_repair'),
    'auto_agents.provider_reference_review': ('validate', 'finish', 'pending_context'),
    ...
    'auto_agents.workflow_chain': ('WorkflowStore.resolve_handoff_chain',
        'WorkflowStore.mark_recovery_required', 'WorkflowStore.begin_resume', 'WorkflowStore.complete'),
