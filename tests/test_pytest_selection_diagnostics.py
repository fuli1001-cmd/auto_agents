...
def test_explicit_node_rejection_reports_effective_retained_selection(tmp_path, source):
    ...
    assert detail['discovery_excluded'] is (True if source == 'discovery' else None)
...
def test_selection_diagnostics_are_bounded_and_redacted(tmp_path):
